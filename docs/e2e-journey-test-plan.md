...
> **Аудит:** ☑ 2026-07-02 (render/axe) + 2026-07-06 (granular) + 2026-07-10 (deep/empty/chat). Відкритий беклог — лише Arvi (B7).
...
- [x] 6.5 **email** SMTP verify. *(06-smtp-mock — 2026-07-09)*
...
- [x] 6.11 media-captions — **N/A** коли `MATERIAL_CAPTIONS_ENABLED` off (skip); soft assert коли on. *(05-06-granular — 2026-07-10)*
...
> **Playwright-тести:** ☑ `specs/audit/07-platform-audit.spec.ts`. **Аудит:** ☑ (2026-07-03).
...
| 🧸 | Arvi-присутність | ☑ | ☑ | ☑ | (наскрізно) | ☑ B7 feature 2026-07-10 (`useArvi`/`ArviSlot`; скріни optional) |

**Interaction-рівень etапів 3–6 + кластери B1–B7 ☑** (2026-07-10). Відкритий беклог — **CI verify** (+ optional Arvi screenshots).

---

## Відкритий беклог (після B7 2026-07-10)

| Кластер | Що лишилось | Тип |
|---------|-------------|-----|
| **B7** | ☑ core feature; optional: `screenshots/arvi/`, richer school-brand theming | feature (done) |
| **CI verify** | Повний `npm run test:e2e` — **не green** (2026-07-10 local): **1658 passed / 160 failed / 135 skipped** (~15m, `PLAYWRIGHT_SKIP_WEBSERVER=1`). ~½ фейлів — auth/public specs на authenticated projects (redirect на dashboard замість login). ~40 унікальних реальних фейлів на intended role (chat mock, vocab play, materials upload/viewer, billing 11.5/11.6, axe deep-equal, тощо). | ops |
...
### B6. Realtime / медіа / зовнішнє — **☑ E2E smoke 2026-07-09**
- **3J.3/7–10**, **3B.6/7**, **3G**, **3L.5**, **6.5**, **3K.5**, **11.10–11**, **4B.*** viewer ☑ (mocked).
- **8.7** host-JWT **N/A** (tenant isolation ☑ `08-rbac-audit`); **4F.8** recurrence materialization — backend-only.

### B7. Feature-робота — **☑ 2026-07-10**
