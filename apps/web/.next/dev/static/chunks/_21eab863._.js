...
const studentRecords = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].filter((u)=>u.role === 'student');
const toProfileViewModel = (userId)=>{
    ...
    if (!user || user.role !== 'student' || user.status === undefined || user.scheduleType === undefined) {
        return null;
    }
...
//# sourceMappingURL=_21eab863._.js.map