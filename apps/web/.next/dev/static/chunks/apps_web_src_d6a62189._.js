...
"[project]/apps/web/src/mocks/domains/lesson-domain.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lesson$2d$domain$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/lesson-domain.ts [app-client] (ecmascript)");
;
...
const mockCalendarEvents = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lesson$2d$domain$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].map(scheduledLessonToCalendarEvent);
function getStudentCalendarEvents(studentId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lesson$2d$domain$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStudentScheduledLessons"])(studentId).map(scheduledLessonToCalendarEvent);
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
function Header() {
    ...
    const lessonsToday = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lesson$2d$domain$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].filter((lesson)=>lesson.date === todayKey && isActiveLesson(lesson.status));
    const remainingToday = lessonsToday.filter((lesson)=>new Date(`${lesson.date}T${lesson.startTime}:00`).getTime() > nowTs);
    const plannedLessonsCount = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lesson$2d$domain$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].filter((lesson)=>lesson.status === 'planned').length;
    const creditedLessonsCount = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lesson$2d$domain$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].filter((lesson)=>lesson.credited).length;
...
//# sourceMappingURL=apps_web_src_d6a62189._.js.map