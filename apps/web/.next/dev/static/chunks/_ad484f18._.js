...
function parseMockRoleFromEnv() {
    ...
    if (raw === undefined || raw === '') return __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id;
    const n = Number(raw);
...
const mockPracticeWeeklySummary = {
    title: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$content$2f$site$2d$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["siteContent"].practice.weeklySummary.title,
    metrics: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$content$2f$site$2d$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["siteContent"].practice.weeklySummary.metrics
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
function getPracticeSummaryForRange(studentId, range) {
    const sessions = mockPracticeSessionLog.filter((entry)=>entry.studentId === studentId && inRange(entry.startedAt, range));
...
function getTrendComparison(studentId, range, previousRange) {
    const currentSessions = mockPracticeSessionLog.filter((entry)=>entry.studentId === studentId && entry.source === 'practice' && inRange(entry.startedAt, range));
    const previousSessions = mockPracticeSessionLog.filter((entry)=>entry.studentId === studentId && entry.source === 'practice' && inRange(entry.startedAt, previousRange));
    ...
    return {
        ...
        delta,
        trend,
        buckets: Array.from(bucketMap.entries()).map(([label, value])=>({
                label,
                value
            }))
    };
...
//# sourceMappingURL=_ad484f18._.js.map