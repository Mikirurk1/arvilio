...
const toProfileViewModel = (userId)=>{
    ...
    if (!user || user.role !== __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id || user.status === undefined || user.scheduleType === undefined) {
        return null;
    }
...
function Header() {
    ...
    const lessonsToday = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lessons$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].filter((lesson)=>lesson.date === todayKey && isActiveLesson(lesson.status));
...
//# sourceMappingURL=_daa1721d._.js.map