...
"[project]/apps/web/src/mocks/mockDb.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/mockDb.ts [app-client] (ecmascript)");
;
...
const resolveUserByRole = (role)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].users.find((user)=>user.role === role);
const activeRole = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_MOCK_ROLE ?? 'teacher';
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setMockDbSessions"])(sessionRows);
const mockUsersByRole = rolePreference.reduce((acc, role)=>{
    const user = resolveUserByRole(role);
    if (user) acc[role] = user;
    return acc;
}, {});
const fallbackUser = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].users[0];
const resolvedActiveUser = mockUsersByRole[activeRole] ?? fallbackUser;
const activeSession = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].sessions.find((session)=>session.userId === resolvedActiveUser.id) ?? {
    id: 'session-fallback',
    accountId: resolvedActiveUser.accountId,
    userId: resolvedActiveUser.id,
    role: resolvedActiveUser.role
};
const activeAccount = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].accounts.find((account)=>account.id === activeSession.accountId) ?? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].accounts[0];
const activeUser = resolvedActiveUser;
const activeMockUser = activeUser;
const mockUsers = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].users.filter((user)=>user.accountId === activeAccount.id);
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setMockDbLessons"])(mockLessons.map((lesson)=>({
        ...lesson,
...
const getLessonsForAccount = (accountId)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].lessons.filter((lesson)=>lesson.accountId === accountId).map(({ accountId: _accountId, ...lesson })=>lesson);
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setMockDbVocabularyWords"])(mockVocabularyWords.map((word)=>({
        ...word,
        accountId: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeAccount"].id,
        userId: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeUser"].id,
        lessonId: word.id === '1' ? '1' : word.id === '2' ? '2' : undefined
    })));
const mockReviewWords = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].reviewWords.filter((word)=>word.accountId === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeAccount"].id && word.userId === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeUser"].id).map(({ id: _id, accountId: _accountId, userId: _userId, ...word })=>word)
];
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setMockDbQuizQuestions"])(mockQuizQuestions.map((question)=>({
        ...question,
        accountId: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeAccount"].id,
        userId: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeUser"].id
    })));
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setMockDbScheduledLessons"])(mockScheduledLessons.map((lesson)=>({
        ...lesson,
        accountId: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeAccount"].id
    })));
...
function getStudentScheduledLessons(studentId) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].scheduledLessons.filter((lesson)=>lesson.accountId === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeAccount"].id && lesson.studentId === studentId).map(({ accountId: _accountId, ...lesson })=>lesson);
}
...
const toProfileViewModel = (userId)=>{
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].users.find((entry)=>entry.id === userId);
    const profile = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].profiles.find((entry)=>entry.userId === userId && entry.accountId === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeAccount"].id);
    const profileMeta = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].profileMeta.find((entry)=>entry.userId === userId && entry.accountId === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeAccount"].id);
    if (!user || user.role !== 'student' || !profile || !profileMeta) return null;
    const teacher = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].users.find((entry)=>entry.id === profileMeta.teacherId);
    const stats = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].profileStats.find((entry)=>entry.accountId === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeAccount"].id && entry.userId === userId);
    return {
        id: user.id,
        accountId: user.accountId,
        userId: user.id,
...
const getVisibleProfiles = (role, userId)=>{
    if (role === 'teacher') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].profileMeta.filter((entry)=>entry.accountId === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeAccount"].id && entry.teacherId === userId).map((entry)=>toProfileViewModel(entry.userId)).filter((entry)=>Boolean(entry));
    }
    if (role === 'admin' || role === 'super-admin') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].profileMeta.filter((entry)=>entry.accountId === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeAccount"].id).map((entry)=>toProfileViewModel(entry.userId)).filter((entry)=>Boolean(entry));
    }
    if (role === 'student') {
...
const mockProfileStatsByAccount = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].profileStats.map((entry)=>({
...
const mockProfileGoals = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].profileGoals.filter((goal)=>goal.accountId === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeAccount"].id && goal.userId === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeUser"].id).map((goal)=>({
        text: goal.text,
        done: goal.done
    }));
const mockPracticeActivities = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].practiceActivities.filter((activity)=>activity.accountId === __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeAccount"].id).map((activity)=>({
        href: activity.href,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setMockDbStudents"])(mockStudents);
function getVisibleStudents(role, userId) {
    if (role === 'teacher') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].students.filter((student)=>student.teacherId === userId);
    }
    if (role === 'admin' || role === 'super-admin') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].students;
    }
    if (role === 'student') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].students.filter((student)=>student.userId === userId);
    }
    return [];
}
function getStudentById(studentId) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$mockDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDb"].students.find((student)=>student.id === studentId);
}
...
function Header() {
    ...
    const lessonsToday = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$calendar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].filter((lesson)=>lesson.date === todayKey && isActiveLesson(lesson.status));
    const remainingToday = lessonsToday.filter((lesson)=>new Date(`${lesson.date}T${lesson.startTime}:00`).getTime() > nowTs);
    const plannedLessonsCount = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$calendar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].filter((lesson)=>lesson.status === 'planned').length;
    const creditedLessonsCount = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$calendar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].filter((lesson)=>lesson.credited).length;
...
//# sourceMappingURL=apps_web_src_86595fcb._.js.map