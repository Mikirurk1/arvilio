...
"[project]/packages/shared/types/src/lib/shared-types.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/packages/shared/types/src/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
const Field = /*#__PURE__*/ _s((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_c = _s(function Field(props, ref) {
    ...
    const resolveReadonlyValue = ()=>{
        ...
        if (props.as === 'select') {
            const selected = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Children"].toArray(props.children).find((child)=>{
                if (!/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidElement"])(child)) return false;
                if (child.type !== 'option') return false;
                return String(child.props.value ?? '') === String(props.value ?? '');
            });
            const selectedLabel = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidElement"])(selected) ? selected.props.children : props.value;
    ...
    if (isTextMode) {
        ...
        return asTextBlock ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: className,
            children: textValue
        }, void 0, false, {
...
"[project]/apps/web/src/components/ui/AdaptiveSelect.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function AdaptiveSelect({ children, className, value, onChange, disabled, readOnly, formatValue, ...rest }) {
    _s();
    ...
    const options = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdaptiveSelect.useMemo[options]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Children"].toArray(children).filter({
                "AdaptiveSelect.useMemo[options]": (child)=>{
                    if (!/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidElement"])(child)) return false;
                    return child.type === 'option';
                }
            }["AdaptiveSelect.useMemo[options]"]).map({
                "AdaptiveSelect.useMemo[options]": (option, index)=>({
                        key: `${String(option.props.value ?? '')}::${index}`,
                        value: String(option.props.value ?? ''),
                        label: option.props.children,
                        disabled: Boolean(option.props.disabled)
                    })
            }["AdaptiveSelect.useMemo[options]"])
    }["AdaptiveSelect.useMemo[options]"], [
        children
    ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdaptiveSelect.useEffect": ()=>{
            const media = window.matchMedia('(max-width: 768px)');
            const apply = {
                "AdaptiveSelect.useEffect.apply": ()=>setIsMobile(media.matches)
            }["AdaptiveSelect.useEffect.apply"];
            apply();
            media.addEventListener('change', apply);
            return ({
                "AdaptiveSelect.useEffect": ()=>media.removeEventListener('change', apply)
            })["AdaptiveSelect.useEffect"];
        }
    }["AdaptiveSelect.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdaptiveSelect.useEffect": ()=>{
            if (!open) return;
            const onPointerDown = {
                "AdaptiveSelect.useEffect.onPointerDown": (event)=>{
                    if (!wrapperRef.current?.contains(event.target)) setOpen(false);
                }
            }["AdaptiveSelect.useEffect.onPointerDown"];
            document.addEventListener('mousedown', onPointerDown);
            return ({
                "AdaptiveSelect.useEffect": ()=>document.removeEventListener('mousedown', onPointerDown)
            })["AdaptiveSelect.useEffect"];
        }
    }["AdaptiveSelect.useEffect"], [
        open
    ...
    if (readOnly) {
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            fileName: "[project]/apps/web/src/components/ui/AdaptiveSelect.tsx",
            lineNumber: 64,
            columnNumber: 12
        }, this);
    }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ref: wrapperRef,
        className: [
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$ui$2e$module$2e$scss__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].adaptiveSelectWrap,
            open ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$ui$2e$module$2e$scss__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].adaptiveSelectWrapOpen : ''
        ].filter(Boolean).join(' '),
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                className: [
                    className,
                    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$ui$2e$module$2e$scss__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].adaptiveSelectTrigger,
                    open ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$ui$2e$module$2e$scss__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].adaptiveSelectTriggerOpen : ''
                ].filter(Boolean).join(' '),
                disabled: disabled,
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$ui$2e$module$2e$scss__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].adaptiveSelectValue,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$ui$2e$module$2e$scss__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].adaptiveSelectChevron,
                        "aria-hidden": true,
            ...
            open ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                role: "listbox",
                className: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$ui$2e$module$2e$scss__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].adaptiveSelectMenu,
                children: options.map((option)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        className: [
                            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$ui$2e$module$2e$scss__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].adaptiveSelectItem,
                            option.value === selectedValue ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$ui$2f$ui$2e$module$2e$scss__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].adaptiveSelectItemActive : ''
                        ].filter(Boolean).join(' '),
                        onClick: ()=>{
...
_s(AdaptiveSelect, "kUcQtcOgpajmjaobqbRdHMykQCc=");
_c = AdaptiveSelect;
var _c;
__turbopack_context__.k.register(_c, "AdaptiveSelect");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/apps/web/src/mocks/domains/linked-accounts.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/mocks/domains/user-preferences.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$linked$2d$accounts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/linked-accounts.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$user$2d$preferences$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/user-preferences.ts [app-client] (ecmascript)");
;
;
;
;
function statsWithUnlocked(counters) {
    return {
        ...counters,
        unlockedAchievementIds: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$achievements$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeUnlockedAchievementIdsFromCounters"])(counters)
    };
}
const mockUsers = [
    {
        id: 1,
        role: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id,
        fullName: 'Mykola Kovalenko',
        email: 'mykola@example.com',
        avatar: {},
        proficiencyLevelId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROFICIENCY_LEVEL"].b2.id,
        telegram: '@mykola',
        phone: '+380 67 123 4567',
        timezoneId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TIME_ZONE"].kyiv.id,
        nativeLanguage: 'Ukrainian',
        bio: 'Full-stack developer learning English for professional growth and international opportunities.',
        statusId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ACCOUNT_STATUS"].active.id,
        scheduleType: true,
        teacherId: 2,
        color: '#3b82c4',
        vocabulary: [
            {
                id: 1,
                vocabularyId: 1,
                statusId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].new,
                ...
                events: [
                    {
                        ...
                        typeId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROFILE_VOCABULARY_PROGRESS_EVENT"].created.id,
                        actorUserId: 2,
                        actorRoleId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id,
                        nextStatusId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].new
                    }
                ]
            },
            {
                ...
                vocabularyId: 2,
                lessonId: 1,
                statusId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].repeated,
                ...
                events: [
                    ...
                    },
                    {
                        ...
                        typeId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROFILE_VOCABULARY_PROGRESS_EVENT"].statusChanged.id,
                        actorUserId: 2,
                        actorRoleId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id,
                        previousStatusId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].new,
                        nextStatusId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].repeated
                    }
                ]
            },
            {
                id: 3,
                vocabularyId: 3,
                statusId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].learned,
                ...
                events: [
                    ...
                    },
                    {
                        ...
                        actorUserId: 2,
                        actorRoleId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id,
                        previousStatusId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].repeated,
                        nextStatusId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].learned
                    }
                ]
            },
            {
        ...
        notificationPrefs: {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$user$2d$preferences$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_NOTIFICATION_PREFS"]
        },
        appearancePrefs: {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$user$2d$preferences$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_APPEARANCE_PREFS"],
            theme: 'dark'
        },
        linkedAccounts: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$linked$2d$accounts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildLinkedAccounts"])({
            google: {
                linked: true,
    ...
    {
        id: 2,
        role: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id,
        fullName: 'Sarah Mitchell',
        email: 'sarah@example.com',
        avatar: {},
        proficiencyLevelId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROFICIENCY_LEVEL"].c1.id,
        telegram: '',
        phone: '',
        timezoneId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TIME_ZONE"].kyiv.id,
        nativeLanguage: '',
    ...
    },
    {
        ...
        avatar: {},
        proficiencyLevelId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROFICIENCY_LEVEL"].b1.id,
        telegram: '@anna',
    ...
    },
    {
        ...
        avatar: {},
        proficiencyLevelId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROFICIENCY_LEVEL"].a2.id,
        telegram: '@dmytro',
        phone: '+380 50 333 4455',
        timezoneId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TIME_ZONE"].warsaw.id,
        nativeLanguage: 'Ukrainian',
        bio: 'Beginner path with focus on vocabulary and listening.',
        statusId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ACCOUNT_STATUS"].paused.id,
        scheduleType: true,
        teacherId: 5,
        color: '#8b5cf6',
        vocabulary: [],
    ...
    {
        id: 6,
        role: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].admin.id,
        fullName: 'Admin Manager',
        email: 'admin@example.com',
        avatar: {},
        proficiencyLevelId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROFICIENCY_LEVEL"].c2.id,
        telegram: '',
        phone: '',
        timezoneId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TIME_ZONE"].kyiv.id,
        nativeLanguage: '',
    ...
    {
        id: 7,
        role: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].superAdmin.id,
...
function parseMockRoleFromEnv() {
    const raw = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_MOCK_ROLE;
    if (raw === undefined || raw === '') return __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id;
    const n = Number(raw);
    if (Number.isFinite(n) && __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE_ID_LIST"].includes(n)) {
        return n;
    }
    const legacy = {
        student: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id,
        teacher: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id,
        admin: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].admin.id,
        'super-admin': __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].superAdmin.id
    };
    return legacy[raw] ?? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id;
}
const rolePreference = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE_ID_LIST"]
];
...
const mockUsers = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"];
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
/** Quick numeric id access for permission matrix. */ const U = {
    ...
    teacher: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id,
    admin: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].admin.id,
    superAdmin: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].superAdmin.id
};
const roleMatrix = {
    dashboard: {
        view: [
...
const scheduleLessonsSeed = [
    {
        ...
        statusId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].completed.id,
        credited: true,
    ...
    },
    {
        ...
        studentId: 3,
        studentName: 'Anna V.',
        statusId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].cancelled.id,
...
const mockLessons = mockScheduledLessons.map((lesson)=>({
        ...
        completed: lesson.statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].completed.id,
        locked: false,
        visibilityByRole: [
            __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id,
            __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id,
            __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].admin.id,
            __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].superAdmin.id
        ]
    }));
...
"[project]/apps/web/src/mocks/domains/vocabulary.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
function vocabularyStatusIdToLegacy(statusId) {
    switch(statusId){
        case __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].new:
            return 'new';
        case __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].repeated:
            return 'repeated';
        case __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].mistakesWork:
            return 'mistakes_work';
        case __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].learned:
            return 'learned';
        default:
            return 'new';
    }
...
function legacyStatusToVocabularyStatusId(status) {
    switch(status){
        case 'new':
            return __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].new;
        case 'repeated':
            return __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].repeated;
        case 'mistakes_work':
            return __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].mistakesWork;
        case 'learned':
            return __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].learned;
        default:
            return __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].new;
    }
}
...
const questionById = new Map(mockQuizQuestions.map((question)=>[
        question.id,
        question
    ]));
...
function userInitials(fullName) {
    return fullName.split(' ').map((chunk)=>chunk.trim()[0]).filter(Boolean).slice(0, 2).join('').toUpperCase();
}
const typeSeconds = {
    'multiple-choice': 38,
    'fill-in': 62
...
function estimateQuizQuestionCount(quiz) {
    return Math.max(1, quiz.questionIds.length);
}
function estimateQuizDurationMinutes(quiz) {
...
function getQuizQuestionsForQuizId(quizId) {
    const quiz = mockQuizEntities.find((entry)=>entry.id === quizId);
    if (!quiz) return [];
    return quiz.questionIds.map((questionId)=>questionById.get(questionId)).filter((question)=>Boolean(question));
}
function mapAssignmentStudent(studentId, status, score) {
    const student = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((entry)=>entry.id === studentId);
    return {
        id: String(studentId),
...
function isStudentRole(roleId) {
    return roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id;
}
function canManageRole(roleId) {
    return roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id || roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].admin.id || roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].superAdmin.id;
}
function getAssignableStudentsForUser(userId, roleId) {
    const students = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].filter((entry)=>entry.role === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id);
    const visibleStudents = roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id ? students.filter((student)=>student.teacherId === userId) : students;
...
function isQuizVisibleForUser(quiz, userId, roleId) {
    if (isStudentRole(roleId)) {
        return quiz.assignments.some((assignment)=>assignment.studentId === userId);
    }
    if (canManageRole(roleId)) {
        return quiz.ownerUserId === userId || quiz.assignments.some((assignment)=>assignment.assignedByUserId === userId);
    }
    return false;
}
function getQuizCardsForUser(userId, roleId) {
    return mockQuizEntities.filter((quiz)=>isQuizVisibleForUser(quiz, userId, roleId)).sort((a, b)=>b.createdAt.localeCompare(a.createdAt)).map((quiz)=>{
        const questions = estimateQuizQuestionCount(quiz);
        const duration = estimateQuizDurationMinutes(quiz);
        const assignedTo = quiz.assignments.length > 0 ? quiz.assignments.map((assignment)=>mapAssignmentStudent(assignment.studentId, assignment.status, assignment.score)) : undefined;
        const scoreValues = quiz.assignments.map((assignment)=>assignment.score).filter((score)=>typeof score === 'number');
        const averageScore = scoreValues.length > 0 ? Math.round(scoreValues.reduce((sum, value)=>sum + value, 0) / scoreValues.length) : undefined;
...
function getLatestQuizForUser(userId, roleId) {
    const cards = getQuizCardsForUser(userId, roleId);
    return cards[0] ?? null;
}
function getQuizTopicsForUser(userId, roleId) {
    return getQuizCardsForUser(userId, roleId).slice(0, 4).map((quiz)=>({
            id: quiz.id,
            title: quiz.title,
...
function assignQuizToStudents(params) {
    const quiz = mockQuizEntities.find((entry)=>entry.id === params.quizId);
    if (!quiz) return;
    const nowIso = new Date().toISOString();
    const nextAssignments = quiz.assignments.filter((assignment)=>!params.studentIds.includes(assignment.studentId));
...
function scheduledLessonToCalendarEvent(lesson) {
    return {
        ...
        statusId: lesson.statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].completed.id ? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].completed.id : __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].planned.id
    };
}
function calendarEventToScheduledLesson(eventItem) {
    ...
    return {
        ...
        credited: eventItem.statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].completed.id,
        order: 1,
        recurrence: 'none',
        weeklyDays: []
    };
...
"[project]/apps/web/src/mocks/domains/goals.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/src/mocks/domains/practice-sessions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const mockPracticeSessionLog = [
    {
        id: 1,
        studentId: 1,
        typeId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRACTICE_SESSION_TYPE"].vocabulary.id,
    ...
    },
    {
        id: 2,
        studentId: 1,
        typeId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRACTICE_SESSION_TYPE"].quiz.id,
    ...
    },
    {
        id: 3,
        studentId: 1,
        typeId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRACTICE_SESSION_TYPE"].speaking.id,
    ...
    },
    {
        id: 6,
        studentId: 1,
        typeId: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRACTICE_SESSION_TYPE"].lesson.id,
...
"[project]/apps/web/src/mocks/domains/statistics.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/entities.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lessons$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/lessons.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$practice$2d$sessions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/practice-sessions.ts [app-client] (ecmascript)");
;
;
;
;
...
function getUserVocabulary(studentId) {
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === studentId);
...
function getVocabularyProgressForRange(studentId, range) {
    ...
    for (const row of rows){
        ...
        if (row.knownAt && inRange(row.knownAt, range) && row.knownByTeacherId) {
            knownWords += 1;
        } else if (row.statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].learned && !row.knownAt && row.events?.some((event)=>event.nextStatusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].learned && event.actorRoleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id && inRange(event.at, range))) {
            knownWords += 1;
        }
    }
    return {
...
function getPracticeSummaryForRange(studentId, range) {
    const sessions = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$practice$2d$sessions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPracticeSessionLog"].filter((entry)=>entry.studentId === studentId && inRange(entry.startedAt, range));
    ...
    const quizzesCompleted = practiceSessions.filter((entry)=>entry.typeId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRACTICE_SESSION_TYPE"].quiz.id).length;
    const speakingSessions = practiceSessions.filter((entry)=>entry.typeId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRACTICE_SESSION_TYPE"].speaking.id).length;
...
function getTrendComparison(studentId, range, previousRange) {
    const currentSessions = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$practice$2d$sessions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPracticeSessionLog"].filter((entry)=>entry.studentId === studentId && entry.source === 'practice' && inRange(entry.startedAt, range));
    const previousSessions = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$practice$2d$sessions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPracticeSessionLog"].filter((entry)=>entry.studentId === studentId && entry.source === 'practice' && inRange(entry.startedAt, previousRange));
...
function aggregateLessons(lessons) {
    ...
    const planned = lessons.filter((l)=>l.statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].planned.id).length;
    const completed = lessons.filter((l)=>l.statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].completed.id).length;
    const cancelledLessons = lessons.filter((l)=>l.statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].cancelled.id);
...
function lessonsInRange(range) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lessons$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].filter((lesson)=>{
...
function lessonsForRole(roleId, userId, range, subjectStudentId) {
    ...
    if (roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id) return scopedByRange.filter((lesson)=>lesson.studentId === userId);
    if (roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id) {
    ...
    if (roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].admin.id) {
        if (subjectStudentId) return scopedByRange.filter((lesson)=>lesson.studentId === subjectStudentId);
    ...
    if (roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].superAdmin.id) {
        if (subjectStudentId) return scopedByRange.filter((lesson)=>lesson.studentId === subjectStudentId);
        return scopedByRange;
    }
    return [];
...
function getRoleStatisticsDashboard(params) {
    ...
    const roleTitle = roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id ? 'Student statistics' : roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id ? 'Teacher statistics' : roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].admin.id ? 'Admin statistics' : 'Super-admin statistics';
    ...
    return {
        ...
        kpis: [
            ...
            ...roleId !== __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id ? [
                {
                    id: 5,
                    label: 'Quizzes completed',
            ...
            ...roleId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].superAdmin.id ? [
                {
                    id: 6,
...
const studentIds = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].filter((user)=>user.role === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id).map((user)=>user.id);
const mockUserPracticeAnalytics = studentIds.map((studentId)=>{
    const sessions = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$practice$2d$sessions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPracticeSessionLog"].filter((session)=>session.studentId === studentId);
    return {
        studentId,
...
function nextSessionLogId() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$practice$2d$sessions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPracticeSessionLog"].reduce((max, row)=>Math.max(max, row.id), 0) + 1;
}
function appendMockPracticeSession(input) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$practice$2d$sessions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPracticeSessionLog"].push(entry);
    ...
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((row)=>row.id === entry.studentId);
    if (user) {
        const currentStats = user.stats ?? {
            ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$achievements$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emptyProfileStats"]
        };
        const nextStats = {
            ...currentStats,
            ...
            quizzesCompleted: currentStats.quizzesCompleted + (entry.source === 'practice' && entry.typeId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRACTICE_SESSION_TYPE"].quiz.id ? 1 : 0),
            speakingSessions: currentStats.speakingSessions + (entry.source === 'practice' && entry.typeId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRACTICE_SESSION_TYPE"].speaking.id ? 1 : 0),
            lessonsCompleted: currentStats.lessonsCompleted + (entry.source === 'lesson' && entry.typeId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRACTICE_SESSION_TYPE"].lesson.id ? 1 : 0)
        };
        user.stats = {
            ...nextStats,
            unlockedAchievementIds: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$achievements$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeUnlockedAchievementIdsFromCounters"])({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$achievements$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/achievements.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$goals$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/goals.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/entities.ts [app-client] (ecmascript)");
...
function nextProfileVocabularyRowId() {
    let max = 0;
    for (const user of __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"]){
...
function getProfileVocabularyForUser(userId) {
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === userId);
    if (!user) return [];
...
function joinProfileVocabulary(userId) {
    ...
    for (const row of getProfileVocabularyForUser(userId)){
        const word = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$vocabulary$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getVocabularyWordById"])(row.vocabularyId);
        if (word) out.push({
            row,
            word,
            status: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$vocabulary$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["vocabularyStatusIdToLegacy"])(row.statusId)
        });
    }
    return out;
}
function updateProfileVocabularyStatus(entryId, statusId) {
    for (const user of __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"]){
        ...
        if (row) {
            ...
            if (statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].learned && user.teacherId > 0) {
                row.knownAt = now;
            ...
            row.events.push({
                ...
                actorRoleId: user.teacherId > 0 ? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id : __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id,
                previousStatusId,
...
function addProfileVocabularyEntry(params) {
    const statusId = params.status ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$vocabulary$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["legacyStatusToVocabularyStatusId"])(params.status) : __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].new;
    const key = profileVocabularyRowKey(params.userId, params.vocabularyId, params.lessonId);
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === params.userId);
    if (!user) return 0;
    ...
    user.vocabulary.push({
        ...
        statusId,
        addedAt: now,
        knownAt: statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].learned && user.teacherId > 0 ? now : undefined,
        knownByTeacherId: statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].learned ? user.teacherId : undefined,
        events: [
            {
                id: Date.now(),
                entryId: id,
...
function countKnownWordsForUser(userId) {
    return getProfileVocabularyForUser(userId).filter((r)=>r.statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VOCABULARY_WORD_STATUS_IDS"].learned).length;
}
function getVocabularyForLesson(userId, lessonId) {
    return joinProfileVocabulary(userId).filter(({ row })=>row.lessonId === lessonId);
}
function getVocabularyForLastLesson(userId) {
    const todayIso = new Date().toISOString().slice(0, 10);
    const completedLessons = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lessons$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].filter((lesson)=>lesson.studentId === userId && lesson.statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].completed.id && lesson.date <= todayIso).sort((a, b)=>b.date.localeCompare(a.date) || b.startTime.localeCompare(a.startTime));
    const withVocabulary = completedLessons.find((lesson)=>getVocabularyForLesson(userId, lesson.id).length > 0);
    if (!withVocabulary) return {
        lessonId: null,
        words: []
    };
    return {
        lessonId: withVocabulary.id,
        words: getVocabularyForLesson(userId, withVocabulary.id)
    };
}
...
function buildVocabularyPlayRound(wordsPool) {
    if (wordsPool.length === 0) return [];
    const poolDefs = Array.from(new Set([
        ...wordsPool.map((item)=>item.word.definition),
        ...__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$vocabulary$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["mockVocabularyWords"].map((word)=>word.definition)
    ].filter((definition)=>Boolean(definition))));
    return wordsPool.map((item)=>{
        const distractors = shuffle(poolDefs.filter((definition)=>definition !== item.word.definition)).slice(0, 3);
...
const mockReviewWords = getReviewWordsForUser(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeUser"].id);
const studentRecords = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].filter((u)=>u.role === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id);
const toProfileViewModel = (userId)=>{
    ...
    if (!user || user.role !== __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id || user.statusId === undefined || typeof user.scheduleType !== 'boolean') {
        return null;
    }
    const teacher = user.teacherId > 0 ? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((entry)=>entry.id === user.teacherId) : undefined;
...
const getVisibleProfiles = (role, userId)=>{
    if (role === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id) {
        return studentRecords().filter((u)=>u.teacherId === userId).map((u)=>toProfileViewModel(u.id)).filter((entry)=>Boolean(entry));
    }
    if (role === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].admin.id || role === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].superAdmin.id) {
        return studentRecords().map((u)=>toProfileViewModel(u.id)).filter((entry)=>Boolean(entry));
    }
    if (role === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id) {
...
const canManageProfile = (currentUser, profile)=>{
    if (currentUser.role === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].teacher.id) return profile.teacherId === currentUser.id;
    return currentUser.role === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].admin.id || currentUser.role === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].superAdmin.id;
};
const getProfileFormByUserId = (userId)=>{
    ...
    return {
        ...
        phone: user.phone,
        timezoneId: user.timezoneId ?? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TIME_ZONE"].kyiv.id,
...
const mockProfileStatsByUserId = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].filter((u)=>u.stats).map((u)=>({
        userId: u.id,
        stats: u.stats
    }));
...
function getProfileStatsForUser(userId) {
    ...
    return entry?.stats ?? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$achievements$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["emptyProfileStats"];
}
function getProfileAchievementsForUserId(userId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$achievements$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildProfileAchievements"])(getProfileStatsForUser(userId));
}
const mockProfileStats = getProfileStatsForUser(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeUser"].id);
const mockProfileGoals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$goals$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDailyGoalsForUser"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeUser"].id).map((g)=>({
        text: g.text,
        done: g.done
    }));
const activeWeekRange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$statistics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRangeBounds"])('week');
const activeWeekPracticeSummary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$statistics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPracticeSummaryForPresetRange"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeUser"].id, 'week');
const activeWeekVocabulary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$statistics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVocabularyProgressForRange"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeUser"].id, activeWeekRange);
const activeWeekQuizzes = Number(activeWeekPracticeSummary.metrics.find((metric)=>metric.id === 2)?.value ?? 0);
const activeWeekSpeaking = Number(activeWeekPracticeSummary.metrics.find((metric)=>metric.id === 3)?.value ?? 0);
function resolvedPracticeStat(title, fallback) {
...
const mockPracticeActivities = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$content$2f$site$2d$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["siteContent"].practiceActivities.map((activity)=>({
        href: activity.href,
...
"[project]/apps/web/src/mocks/domains/user-prefs-access.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getNotificationPrefsForUser(userId) {
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === userId);
    return user?.notificationPrefs ?? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$user$2d$preferences$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_NOTIFICATION_PREFS"];
}
...
function getAppearancePrefsForUser(userId) {
    const user = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$entities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === userId);
    return user?.appearancePrefs ?? __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$user$2d$preferences$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_APPEARANCE_PREFS"];
}
...
function patchAppearancePrefsForUser(userId, patch) {
    const merged = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$user$2d$preferences$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeAppearancePrefs"])({
...
function patchNotificationPrefsForUser(userId, patch) {
    const merged = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$user$2d$preferences$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeNotificationPrefs"])({
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$achievements$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/achievements.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$user$2d$preferences$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/user-preferences.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$user$2d$prefs$2d$access$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/user-prefs-access.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$linked$2d$accounts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/linked-accounts.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$statistics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/statistics.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$practice$2d$sessions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/mocks/domains/practice-sessions.ts [app-client] (ecmascript)");
;
...
"[project]/apps/web/src/lib/lessonTime.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getIanaForTimeZoneId(id) {
    const resolved = id ?? __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TIME_ZONE"].kyiv.id;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTimeZoneById"])(resolved)?.iana ?? 'Europe/Kyiv';
}
function lessonStartUtc(lesson) {
    const iana = getIanaForTimeZoneId(lesson.timezoneId);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$toDate$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDate"])(`${lesson.date}T${lesson.startTime}:00`, {
        timeZone: iana
    });
}
function lessonEndUtc(lesson) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addMinutes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addMinutes"])(lessonStartUtc(lesson), lesson.duration);
}
function lessonDateKeyInZone(lesson, viewerIana) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$formatInTimeZone$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatInTimeZone"])(lessonStartUtc(lesson), viewerIana, 'yyyy-MM-dd');
}
function lessonStartTimeInZone(lesson, viewerIana) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$formatInTimeZone$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatInTimeZone"])(lessonStartUtc(lesson), viewerIana, 'HH:mm');
}
function lessonEndTimeInZone(lesson, viewerIana) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$formatInTimeZone$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatInTimeZone"])(lessonEndUtc(lesson), viewerIana, 'HH:mm');
}
function viewerSlotToLessonWall(viewerDate, viewerStartTime, duration, viewerIana, lessonTimezoneId) {
    const utc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$toDate$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDate"])(`${viewerDate}T${viewerStartTime}:00`, {
        timeZone: viewerIana
    });
    const lessonIana = getIanaForTimeZoneId(lessonTimezoneId);
    const date = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$formatInTimeZone$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatInTimeZone"])(utc, lessonIana, 'yyyy-MM-dd');
    const startTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$formatInTimeZone$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatInTimeZone"])(utc, lessonIana, 'HH:mm');
    const endUtc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addMinutes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addMinutes"])(utc, duration);
    const endTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$formatInTimeZone$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatInTimeZone"])(endUtc, lessonIana, 'HH:mm');
    return {
        date,
        startTime,
        endTime
...
function moveLessonToViewerCalendarDay(lesson, newViewerDateStr, viewerIana) {
    ...
    const oldViewerTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$formatInTimeZone$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatInTimeZone"])(start, viewerIana, 'HH:mm');
...
function Header() {
    _s();
    const [avatarUrl, setAvatarUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeMockUser"].avatar.url ?? '');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Header.useEffect": ()=>{
            const onAvatarUpdated = {
                "Header.useEffect.onAvatarUpdated": (event)=>{
                    const customEvent = event;
                    if (customEvent.detail?.userId !== __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeMockUser"].id) return;
                    setAvatarUrl(customEvent.detail?.avatarUrl ?? '');
                }
            }["Header.useEffect.onAvatarUpdated"];
            window.addEventListener('mock-user-avatar-updated', onAvatarUpdated);
            return ({
                "Header.useEffect": ()=>window.removeEventListener('mock-user-avatar-updated', onAvatarUpdated)
            })["Header.useEffect"];
        }
    }["Header.useEffect"], []);
    ...
    const todayKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$formatInTimeZone$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatInTimeZone"])(new Date(), viewerIana, 'yyyy-MM-dd');
    const nowTs = Date.now();
    const isActiveLesson = (statusId)=>statusId !== __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].cancelled.id;
    const lessonsToday = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lessons$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].filter((lesson)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$lessonTime$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lessonDateKeyInZone"])(lesson, viewerIana) === todayKey && isActiveLesson(lesson.statusId));
    const remainingToday = lessonsToday.filter((lesson)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$lessonTime$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lessonStartUtc"])(lesson).getTime() > nowTs);
    const plannedLessonsCount = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lessons$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].filter((lesson)=>lesson.statusId === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LESSON_STATUS"].planned.id).length;
    const creditedLessonsCount = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$lessons$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockScheduledLessons"].filter((lesson)=>lesson.credited).length;
    ...
    const showTotalForAdmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$roles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAdminOrSuper"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeMockUser"].role) && (myTodayCount !== totalTodayCount || myRemainingCount !== totalRemainingCount);
    const showCreateLesson = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$roles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canSchedule"])('lessons', __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeMockUser"].role);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    showCreateLesson ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$components$2f$layout$2f$Header$2e$module$2e$scss__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].headerCreateLesson,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeMockUser"].role === __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$types$2f$src$2f$lib$2f$shared$2d$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_ROLE"].student.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                            ...
                            lineNumber: 125,
                            columnNumber: 13
                        }, this) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$avatar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAvatarFallbackInitials"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeMockUser"].fullName)
                    }, void 0, false, {
                        fileName: "[project]/apps/web/src/components/layout/Header.tsx",
                        lineNumber: 122,
                        columnNumber: 9
...
_s(Header, "1q8aBsf9sIt8ETLHi6QyxCMD4Po=");
_c = Header;
var _c;
...
function Sidebar() {
    _s();
    const practiceTotal = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$domains$2f$profile$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPracticeActivities"].reduce((sum, activity)=>{
        if (!activity.stat) return sum;
        const match = activity.stat.match(/\d+/);
        return sum + (match ? Number(match[0]) : 0);
    }, 0);
    const canSeeStudents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$roles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTeacherAdminOrSuper"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$mocks$2f$session$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["activeMockUser"].role);
    const visibleNavItems = navItems.map((section)=>({
            ...section,
            items: section.items.filter((item)=>item.href === '/students' ? canSeeStudents : true).map((item)=>item.href === '/practice' ? {
                    ...item,
                    badge: String(practiceTotal),
                    badgeColor: 'green'
                } : item)
        }));
...
//# sourceMappingURL=_0127b550._.js.map