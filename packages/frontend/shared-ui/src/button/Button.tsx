...
export type ButtonProps = Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'onClick' | 'style'> & {
  /**
   * Visual style. Use `bare` for custom-styled hit targets (cards, icon chips) —
   * renders a real `<button>` without design-system chrome.
   */
  variant?: 'default' | 'primary' | 'ghost' | 'dashed' | 'danger' | 'bare';
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  const sharedClassName = [
    variant === 'bare' ? undefined : uiStyles.buttonBase,
    variantClass,
